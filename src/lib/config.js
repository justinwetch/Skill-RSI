...
export const DEFAULT_PROJECT_CONFIG = {
  ...
  models: {
    agent: 'gpt-6-sol',       // ontology, deconstructor, planner, creator, reviewer, analyst
    generation: 'gpt-6-sol',  // runs candidate skills to produce eval outputs
    judge: 'gpt-6-sol',       // scores eval outputs
    agentMaxTokens: 8192,
