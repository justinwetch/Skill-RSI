...
| `05-evidence-prompts.png` | Prompt evidence list | Collapsed prompt judgments. |
| `06-evidence-prompt-expanded.png` | Expanded prompt evidence | Prompt detail with candidate outputs and judge rationale. |
| `07-champion-skill.png` | Champion skill viewer | Current champion package. |
