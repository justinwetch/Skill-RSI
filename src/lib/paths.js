...
export function getProjectPaths(cwd, projectName) {
  ...
  return {
    ...
    championSkillDir,
    researchCurrent: path.join(projectDir, 'research', 'current-packet.json'),
...
export function getRunPaths(projectPaths, runId) {
  ...
  return {
    ...
    researchDir: path.join(runDir, 'research'),
    researchPacketJson: path.join(runDir, 'research', 'research-packet.json'),
    researchRawJson: path.join(runDir, 'research', 'raw-response.json'),
    ontologyQualityReportJson: path.join(runDir, 'deconstruction', 'ontology-quality-report.json'),
    deconstructionQualityReportJson: path.join(runDir, 'deconstruction', 'deconstruction-quality-report.json'),
    ...
    challengerDir: path.join(runDir, 'challenger'),
